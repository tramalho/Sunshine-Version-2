...
public class ForecastAdapter extends CursorAdapter {
    ...
    private boolean useLayoutToday = true;
    ...
    public void setUseLayoutToday(boolean useLayoutToday) {
        this.useLayoutToday = useLayoutToday;
    }

    @Override
    public int getItemViewType(int position) {
        return (position == 0 && useLayoutToday) ? VIEW_TYPE_TODAY : VIEW_TYPE_FUTURE_DAY;
    }
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        int iconResourceForWeatherCondition = Utility.getArtResourceForWeatherCondition(weatherId);

        if(viewType  != VIEW_TYPE_TODAY){
            iconResourceForWeatherCondition = Utility.getIconResourceForWeatherCondition(weatherId);
        }
        ...
        viewHolder.dateView.setText(Utility.getFriendlyDayString(mContext, longDate));
