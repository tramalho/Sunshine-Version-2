...
public class SunshineService extends IntentService {
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if ( cVVector.size() > 0 ) {
                ...
                insertCount = this.getContentResolver().bulkInsert(WeatherContract.WeatherEntry.CONTENT_URI, cVVector.toArray(contentValues));
            }

            Log.d(LOG_TAG, LOG_TAG + " Complete. " + insertCount + " Inserted");
    ...
    public static  class  AlarmReceiver extends BroadcastReceiver{
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Intent alarmIntent = new Intent(context, SunshineService.class);
